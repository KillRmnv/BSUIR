...
from functions_by_class_name
where class_name = class_name_var;
$$;
...
values ('Subscription', 'insert_subsription(?,?,?::date,?,?)', 'read_subscription(?,?,?,?::date,?::date,?,?)',
        'update_subscription(?,?,?,?::date,?,?)',
        'delete_subscription(?,?,?::date,?::date,?,?)', 'read_subscription_page(?,?)'),

       ('HistoryRecord', 'insert_history(?::date,?,?,?)', 'read_history(?,?::date,?,?,?)',
        'update_history(?,?::date,?,?,?)',
       ...
       ('Delivery', 'insert_delivery(?,?,?,?::date)', 'read_delivery(?,?,?,?,?::date)', 'update_delivery(?,?,?,?,?::date)',
        'delete_delivery(?,?,?,?,?::date)', 'read_delivery_page(?,?,?,?,?::date)');
insert into functions_by_class_name
(class_name, create_procedure, read_function, update_procedure, delete_function, read_page_function)
values ('Circulation',
        'insert_circulation(?,?,?,?)',
