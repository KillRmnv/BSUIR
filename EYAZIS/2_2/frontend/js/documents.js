...
async function loadDocuments() {
    try {
        ...
        data.documents.forEach(doc => {
            ...
            const langBadge = doc.lang ? `<span class="lang-badge lang-${escapeHtml(doc.lang)}">${escapeHtml(LANG_LABELS[doc.lang] || doc.lang)}</span>` : '';
            row.innerHTML = `
                <div class="doc-info">
                ...
                <div class="doc-actions">
                    ...
                    <a href="${API_BASE}/documents/${doc.id}/download" class="btn btn-small btn-secondary" onclick="event.stopPropagation();">Download</a>
