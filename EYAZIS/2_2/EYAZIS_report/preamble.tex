...
\usepackage{xcolor}
\usepackage{hyphenat}
\providecommand{\cyrchar}[1]{#1} % fallback для literate-маппинга кириллицы в lstset
\lstset{
...
\addto\captionsrussian{
	...
	\providecommand{\listingscaption}{Листинг}
...
% \AtBeginDocument{\numberwithin{listing}{section}}  % отключено: minted не используется
...
\usepackage{verbatim}
\usepackage{xcolor}
% \usepackage{minted}  % отключено: конфликт с текущим TeX Live
% listing float не нужен — в отчёте нет листингов кода
