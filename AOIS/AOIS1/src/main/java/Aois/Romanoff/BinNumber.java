...
public class BinNumber {
    ...
    private void performDivision(ArrayList<Integer> anthrBin, ArrayList<Integer> substracted, ArrayList<Integer> IntegerDigits, ArrayList<Integer> remainer, ArrayList<Integer> temp, int currPos, boolean remainCounting) {
        ArrayList<Integer> result = new ArrayList<>();
    ...
    private void processRemainder(ArrayList<Integer> IntegerDigits, ArrayList<Integer> remainer, boolean sign) {
